// URL: https://observablehq.com/@randomfractals/chicago-public-passenger-vehicles
...
SummaryTable(data, {label: 'Public Passenger Vehicles Data'})
)})
    },
    {
...
md`## Vehicle Types`
    ...
    {
      name: "vehicleTypesPlot",
      inputs: ["vl","vehicleTypes"],
      value: (function(vl,vehicleTypes){return(
vl.markBar().data(vehicleTypes).encode(
  ...
  vl.color().fieldN('vehicle_type')
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`## Vehicle Fuel Sources`
)})
    },
    {
      name: "vehicleFuelSourcesPlot",
      inputs: ["vl","vehicleFuelSources"],
      value: (function(vl,vehicleFuelSources){return(
vl.markBar().data(vehicleFuelSources).encode(
  ...
  vl.color().fieldN('vehicle_fuel_source')
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`## Vehicle Status Info`
)})
    },
    {
      name: "vehicleStatusInfoPlot",
      inputs: ["vl","vehicleStatusData"],
      value: (function(vl,vehicleStatusData){return(
vl.markBar().data(vehicleStatusData).encode(
...
md`## Company Vehicles`
    ...
    {
      name: "viewof companyVehiclesTable",
      inputs: ["Inputs","companyVehicles"],
      value: (function(Inputs,companyVehicles){return(
Inputs.table(companyVehicles)
)})
    },
    {
      name: "companyVehiclesTable",
      inputs: ["Generators","viewof companyVehiclesTable"],
      value: (G, _) => G.input(_)
    },
    {
      inputs: ["md"],
...
'https://data.cityofchicago.org/resource/tfm3-3j95.json'
)})
    },
    {
      name: "query",
...
await fetch(dataUrl + query).then(data => data.json())
    ...
    },
    {
      name: "dataTable",
      inputs: ["aq","data"],
      value: (function(aq,data){return(
aq.from(data).orderby('status')
)})
    },
    {
      name: "vehicleTypes",
...
dataTable.select('vehicle_type').groupby('vehicle_type').count().orderby(aq.desc('count'))
)})
    },
    {
      name: "vehicleFuelSources",
      inputs: ["dataTable","aq"],
      value: (function(dataTable,aq){return(
dataTable.select('vehicle_fuel_source').groupby('vehicle_fuel_source').count().orderby(aq.desc('count'))
)})
    },
    {
      ...
      inputs: ["dataTable","aq"],
      value: (function(dataTable,aq){return(
dataTable.select('status').groupby('status').count().orderby(aq.desc('count'))
)})
    },
    {
      ...
      inputs: ["dataTable","aq"],
      value: (function(dataTable,aq){return(
dataTable.select('company_name').groupby('company_name').count().orderby(aq.desc('count'))
)})
    },
    {
      inputs: ["md"],
