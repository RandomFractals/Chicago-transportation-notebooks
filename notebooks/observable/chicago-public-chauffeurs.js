...
SummaryTable(data, {label: 'Public Chauffeurs Data'})
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`## License Type and Status Plots`
)})
    },
    {
      name: "viewof licensePlots",
      inputs: ["vl","driverTypeData","licenseStatusData","licenseTypeData"],
      value: (function(vl,driverTypeData,licenseStatusData,licenseTypeData)
{
  ...
  return vl.hconcat(driverTypePlot, licenseStatusPlot, licenseTypePlot).render();
    ...
    {
      name: "licensePlots",
      inputs: ["Generators","viewof licensePlots"],
      value: (G, _) => G.input(_)
    },
    {
      inputs: ["md"],
...
dataTable.select('driver_type').groupby('driver_type').count().orderby(aq.desc('count'))
)})
    },
    {
      name: "licenseStatusData",
      inputs: ["dataTable","aq"],
      value: (function(dataTable,aq){return(
dataTable.select('status').groupby('status').count().orderby(aq.desc('count'))
    ...
    {
      name: "licenseTypeData",
      inputs: ["dataTable","aq"],
      value: (function(dataTable,aq){return(
dataTable.select('license_type').groupby('license_type').count().orderby(aq.desc('count'))
)})
    },
    {
      inputs: ["md"],
