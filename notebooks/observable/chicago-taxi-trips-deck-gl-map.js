...
`
    ...
    {
      inputs: ["md","geoDataTable","geoTrips","tripLocations"],
      value: (function(md,geoDataTable,geoTrips,tripLocations){return(
md`## ${geoDataTable.totalRows().toLocaleString()} geo located trips | ${geoTrips.totalRows().toLocaleString()} routes | ${tripLocations.totalRows().toLocaleString()} locations`
    ...
    },
    {
      ...
      inputs: ["Inputs","md","year"],
      value: (function(Inputs,md,year){return(
Inputs.date({
...
md`TODO: add trips layer`
    ...
    {
      name: "tripLocationsGridLayer",
      inputs: ["deck","tripLocations","colorRange","onHover","deckgl"],
      value: (function(deck,tripLocations,colorRange,onHover,deckgl)
{
...
tripDate.toISOString().substring(0, 10)
    ...
    },
    {
      name: "query",
      inputs: ["tripsDate"],
      value: (function(tripsDate){return(
...
tripRoutes.union(tripRoutes)
    ...
    },
    {
      ...
      inputs: ["forwardGeoTrips"],
      value: (function(forwardGeoTrips){return(
forwardGeoTrips
  .rename({
    ...
    {
      name: "geoTrips",
      inputs: ["forwardGeoTrips","reversedGeoTrips"],
      value: (function(forwardGeoTrips,reversedGeoTrips){return(
